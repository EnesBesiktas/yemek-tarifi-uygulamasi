  ...
  Widget build(BuildContext context) {
    ...
    final List<Category> mainCategories = [
      ...
      Category(
        ...
        subCategories: [
          SubCategory(
            ...
            imageUrl: 'assets/images/ozeldiyetler/dusuk-karbonhidrat.jpg',
            description: 'Düşük karbonhidrat içeren sağlıklı tarifler',
          ),
          SubCategory(
            id: '4-2',
            name: 'Keto',
            imageUrl: 'assets/images/ozeldiyetler/keto.jpg',
            description: 'Ketojenik beslenmeye uygun yağ oranı yüksek tarifler',
          ),
          SubCategory(
            id: '4-3',
            name: 'Glutensiz',
            imageUrl: 'assets/images/ozeldiyetler/glutensiz.jpeg',
            description: 'Gluten içermeyen hamur işleri ve yemekler',
          ),
          SubCategory(
            id: '4-4',
            name: 'Şekersiz',
            imageUrl: 'assets/images/ozeldiyetler/sekersiz.jpeg',
            description: 'Şeker ilavesiz sağlıklı tatlılar',
          ),
          SubCategory(
            id: '4-5',
            name: 'Paleo',
            imageUrl: 'assets/images/ozeldiyetler/paleo.jpeg',
      ...
      Category(
        ...
        subCategories: [
          SubCategory(
            ...
            imageUrl: 'assets/images/zamanvezorluk/15-dakikada-tarifler.jpg',
            description: 'Sadece 15 dakikada hazırlayabileceğiniz pratik tarifler',
          ),
          SubCategory(
            id: '5-2',
            name: 'Kolay Tarifler',
            imageUrl: 'assets/images/zamanvezorluk/kolay-tarifler.jpeg',
            description: 'Mutfakta yeni olanlar için basit ve kolay tarifler',
          ),
          SubCategory(
            id: '5-3',
            name: 'Tek Tencere Yemekler',
            imageUrl: 'assets/images/zamanvezorluk/tek-tencere-yemekler.jpeg',
            description: 'Tek tencerede pişirilen pratik yemekler',
          ),
          SubCategory(
            id: '5-4',
            name: 'Öğrenci Yemekleri',
            imageUrl: 'assets/images/zamanvezorluk/ogrenci-yemekleri.jpeg',
      ...
      Category(
        ...
        description: 'Sıcak ve soğuk içecek tarifleri',
        icon: Icons.local_drink,
        subCategories: [
          SubCategory(
            id: '6-1',
            name: 'Sıcak İçecekler',
            imageUrl: 'assets/images/icecekler/sicak-icecekler.jpeg',
            description: 'Kahve, çay ve diğer sıcak içecek tarifleri',
          ),
          SubCategory(
            id: '6-2',
            name: 'Ev Yapımı Soğuk İçecekler',
            imageUrl: 'assets/images/icecekler/ev-yapimi-soguk-icecekler.jpeg',
            description: 'Limonata, meyve suyu ve diğer soğuk içecek tarifleri',
          ),
          SubCategory(
            id: '6-3',
            name: 'Smoothie ve Detoks',
            imageUrl: 'assets/images/icecekler/smoothie-ve-detoks.jpg',
      ...
      Category(
        ...
        description: 'Tatlı ve hamur işi tarifleri',
        icon: Icons.cake,
        subCategories: [
          SubCategory(
            id: '7-1',
            name: 'Pastalar',
            imageUrl: 'assets/images/tatlilarvehamurisleri/pastalar.jpg',
            description: 'Yaş pasta ve kuru pasta tarifleri',
          ),
          SubCategory(
            id: '7-2',
            name: 'Kurabiyeler',
            imageUrl: 'assets/images/tatlilarvehamurisleri/kurabiyeler.jpeg',
            description: 'Tuzlu ve tatlı kurabiye tarifleri',
          ),
          SubCategory(
            id: '7-3',
            name: 'Şerbetli Tatlılar',
            imageUrl: 'assets/images/tatlilarvehamurisleri/serbetli-tatlilar.jpg',
            description: 'Geleneksel şerbetli tatlı tarifleri',
          ),
          SubCategory(
            id: '7-4',
            name: 'Sütlü Tatlılar',
            imageUrl: 'assets/images/tatlilarvehamurisleri/sutlu-tatlilar.jpg',
            description: 'Sütlü ve hafif tatlı tarifleri',
          ),
          SubCategory(
            id: '7-5',
            name: 'Ekmek ve Poğaçalar',
            imageUrl: 'assets/images/tatlilarvehamurisleri/ekmek-ve-pogacalar.jpg',
    ...
    final List<Recipe> dailyRecipes = [
      Recipe(
        ...
        imageUrl: 'assets/kremalı mantar çorbası.jpeg',
      ...
      Recipe(
        ...
        imageUrl: 'assets/fırında tavuk but.jpeg',
      ...
      Recipe(
        ...
        imageUrl: 'assets/karamelli cheesecake.jpg',
